...
def Toffoli(a,b,c):
    return C_NOTn(a,b)@multi_gate(H,c)@multi_gate(S,a)@C_NOTn(b,c)@C_NOTn(c,a)@multi_gate(T_dag,a)@multi_gate(T_dag,b)@multi_gate(T,c)@C_NOTn(b,a)@multi_gate(T_dag,a)@C_NOTn(b,c)@C_NOTn(c,a)@C_NOTn(a,b)@multi_gate(T_dag,a)@multi_gate(T,b)@multi_gate(T,c)@multi_gate(H,c)
...
for k in range(repeat):
    ...
    H_corrected = C_NOTn(1,2)@C_NOTn(1,3)@Toffoli(3,2,1)@multi_gate(H,1)@Toffoli(3,2,1)@C_NOTn(1,3)@C_NOTn(1,2)
