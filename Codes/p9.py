...
Tof[6][7] = 1
Tof[7][6] = 1
Toffoli = (C_NOTn(1, 2) @ multi_gate(H, 3) @ multi_gate(S, 1) @ C_NOTn(2, 3) @ C_NOTn(3, 1) @ multi_gate(T_dag,
                                                                                                         1) @ multi_gate(
    T_dag, 2) @ multi_gate(T, 3) @ C_NOTn(2, 1) @ multi_gate(T_dag, 1) @ C_NOTn(2, 3) @ C_NOTn(3, 1) @ C_NOTn(1,
                                                                                                              2) @ multi_gate(
    T_dag, 1) @ multi_gate(T, 2) @ multi_gate(T, 3) @ multi_gate(H, 3)).real
