"""
Programming Project 16 with N = 17
Ankit Khandelwal
15863
"""
...
X_stabilizers[0][3] = 5
X_stabilizers[0][4] = 9
X_stabilizers[0][5] = [3, 4]
X_stabilizers[1][0] = 6
X_stabilizers[1][1] = 'a'
X_stabilizers[1][2] = 5
X_stabilizers[1][3] = 'a'
X_stabilizers[1][4] = 11
X_stabilizers[1][5] = [5, 4]
X_stabilizers[2][0] = 12
X_stabilizers[2][1] = 7
X_stabilizers[2][2] = 'a'
X_stabilizers[2][3] = 13
X_stabilizers[2][4] = 'a'
X_stabilizers[2][5] = [1, 2]
X_stabilizers[3][0] = 14
X_stabilizers[3][1] = 9
X_stabilizers[3][2] = 13
X_stabilizers[3][3] = 15
X_stabilizers[3][4] = 16
X_stabilizers[3][5] = [3, 2]
...
Z_stabilizers[0][3] = 2
Z_stabilizers[0][4] = 3
Z_stabilizers[0][5] = [2, 5]
Z_stabilizers[1][0] = 8
Z_stabilizers[1][1] = 3
Z_stabilizers[1][2] = 7
Z_stabilizers[1][3] = 9
Z_stabilizers[1][4] = 13
Z_stabilizers[1][5] = [2, 3]
Z_stabilizers[2][0] = 10
Z_stabilizers[2][1] = 5
Z_stabilizers[2][2] = 9
Z_stabilizers[2][3] = 11
Z_stabilizers[2][4] = 15
Z_stabilizers[2][5] = [4, 3]
Z_stabilizers[3][0] = 17
Z_stabilizers[3][1] = 15
Z_stabilizers[3][2] = 16
Z_stabilizers[3][3] = 'a'
Z_stabilizers[3][4] = 'a'
...
def stab_cycle(psi, error):
    if error == True:
        ...
        gates = ['I', 'X', 'Y', 'Z']
        for i in range(dnos):
            a = np.random.choice(gates, 1,
                                 p=[1 - error_prob, error_prob_per_gate, error_prob_per_gate, error_prob_per_gate])
            b = a[0]
            if b == 'I':
                continue
            elif b == 'X':
...
for ii in range(repeat):
    ...
    syndrome_old, psi = stab_cycle(psi, error=0)

    Z_l_init, psi = meas_ZL(psi)
    if Z_l_init == 1:
        pending_gate = 1

    syndrome_new, psi = stab_cycle(psi, 1)
